...
const wchar_t* kJa[static_cast<size_t>(StringId::kCount)] = {
  ...
  L"\u4E00\u822C",
  L"Aura",
  L"\u753B\u9762\u306E\u7E01\u306B\u63CF\u304B\u308C\u308B\u30B0\u30E9\u30C7\u30FC\u30B7\u30E7\u30F3\u304C\u8996\u754C\u306E\u968E\u306B\u6620\u308B\u3053\u3068\u3067IME\u306E\u72B6\u614B\u304C\u3059\u3050\u306B\u308F\u304B\u308B\u3002\u3053\u308C\u3067\u6253\u3061\u9593\u9055\u3048\u3092\u6E1B\u3089\u305B\u308B\u3053\u3068\u9593\u9055\u3044\u306A\u3057\u3002",
  L"Aura \u3092\u6709\u52B9\u306B\u3059\u308B",
  L"\u8272",
  L"\u8A00\u8A9E\u3054\u3068\u306E\u753B\u9762\u7E01\u306E\u8272\u3092\u8A2D\u5B9A\u3057\u307E\u3059",
  L"\u65E5\u672C\u8A9E",
  ...
  L"IME Aura \u3092\u7D42\u4E86\u3057\u307E\u3059\u304B\uFF1F\n\u753B\u9762\u7E01\u306E\u30B0\u30E9\u30C7\u30FC\u30B7\u30E7\u30F3\u8868\u793A\u3082\u6D88\u3048\u307E\u3059\u3002",
  L"Firefly",
  L"CapsLock\u30AD\u30FC\u306B\u7570\u306A\u308B\u6A5F\u80FD\u3092\u5272\u308A\u5F53\u3066\u308B\u3053\u3068\u3067\u3001\u5ACC\u308F\u308C\u3066\u3044\u308B\u30AD\u30FC\u3092\u4E00\u756A\u597D\u304D\u306A\u30AD\u30FC\u306B\u3059\u308B\u3053\u3068\u304C\u3067\u304D\u307E\u3059\u3002\u5272\u308A\u5F53\u3066\u308B\u6A5F\u80FD\u306F\u4EE5\u4E0B\u306E\u30EA\u30B9\u30C8\u306E\u4E2D\u304B\u3089\u9078\u3093\u3067\u304F\u3060\u3055\u3044\u3002",
  L"Firefly \u6A5F\u80FD\u3092\u6709\u52B9\u306B\u3059\u308B",
  L"\u30A2\u30AF\u30C6\u30A3\u30D6",
  L"\u975E\u30A2\u30AF\u30C6\u30A3\u30D6",
  L"CapsLock \u306E\u72B6\u614B",
...
const wchar_t* kEn[static_cast<size_t>(StringId::kCount)] = {
  ...
  L"General",
  L"Aura",
  L"A gradient along the screen edge catches your eye in the periphery, so you can tell the IME state at a glance. Fewer typos\u2014guaranteed.",
  L"Enable Aura",
  L"Color",
  ...
  L"Firefly",
  L"Assign a different function to the Caps Lock key and turn the worst key into your favorite. Choose a function from the list below.",
  L"Enable Firefly",
  L"Active",
  L"Inactive",
  L"CapsLock state",
  ...
  L"Mute microphone and speakers",
  L"Custom key press",
  L"Keep display on",
  L"Prevent PC sleep",
  L"Voice typing shortcut",
...
const wchar_t* kZhHans[static_cast<size_t>(StringId::kCount)] = {
  ...
  L"\u4E00\u822C",
  L"Aura",
  L"\u5C4F\u5E55\u8FB9\u7F18\u7684\u6E10\u53D8\u4F1A\u6620\u5165\u4F60\u7684\u4F59\u5149\uFF0C\u8BA9\u4F60\u7ACB\u523B\u4E86\u89E3\u8F93\u5165\u6CD5\u72B6\u6001\u3002\u8FD9\u6837\u6253\u5B57\u51FA\u9519\u80AF\u5B9A\u4F1A\u51CF\u5C11\u3002",
  L"\u542F\u7528 Aura",
  L"\u989C\u8272",
  L"\u4E3A\u6BCF\u79CD\u8F93\u5165\u8BED\u8A00\u8BBE\u7F6E\u5C4F\u5E55\u8FB9\u7F18\u989C\u8272",
  L"\u65E5\u8BED",
...
const wchar_t* kZhHant[static_cast<size_t>(StringId::kCount)] = {
  ...
  L"\u4E00\u822C",
  L"Aura",
  L"\u87A2\u5E55\u908A\u7DE3\u7684\u6F38\u5C64\u6703\u6620\u5165\u4F60\u7684\u9918\u5149\uFF0C\u8B93\u4F60\u7ACB\u523B\u4E86\u89E3\u8F38\u5165\u6CD5\u72C0\u614B\u3002\u9019\u6A23\u6253\u932F\u5B57\u80AF\u5B9A\u6703\u6E1B\u5C11\u3002",
  L"\u555F\u7528 Aura",
  L"\u984F\u8272",
  L"\u70BA\u6BCF\u7A2E\u8F38\u5165\u8A9E\u8A00\u8A2D\u5B9A\u87A2\u5E55\u908A\u7DE3\u984F\u8272",
  L"\u65E5\u8A9E",
...
const wchar_t* kKo[static_cast<size_t>(StringId::kCount)] = {
  ...
  L"\uC77C\uBC18",
  L"Aura",
  L"\uD654\uBA74 \uAC00\uC7A5\uC790\uB9AC\uC758 \uADF8\uB77C\uB370\uC774\uC158\uC774 \uC2DC\uC57C\uC758 \uC8FC\uBCC0\uBD80\uC5D0 \uBCF4\uC5EC IME \uC0C1\uD0DC\uB97C \uBC14\uB85C \uC54C \uC218 \uC788\uC2B5\uB2C8\uB2E4. \uC774\uB807\uAC8C \uD558\uBA74 \uC624\uD0C0\uAC00 \uC904\uC5B4\uB4DC\uB294 \uAC74 \uD655\uC2E4\uD569\uB2C8\uB2E4.",
  L"Aura \uC0AC\uC6A9",
  L"\uC0C9\uC0C1",
...
StringId string_id_for_busy_action(const std::string& action_key) {
  ...
  if (a == kFireflyBusyAudioMute) return StringId::kFireflyBusyAudioMute;
  if (a == kFireflyBusyCustomKey) return StringId::kFireflyBusyCustomKey;
